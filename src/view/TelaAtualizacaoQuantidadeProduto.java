...
public class TelaAtualizacaoQuantidadeProduto extends JFrame {
	...
	public TelaAtualizacaoQuantidadeProduto() {
		setTitle("Atualizar a quantidade de Produto");
	...
	private void criarTextFieldId(String label) {
		...
		textFieldCodigo.setPreferredSize(new Dimension(400,40));
	...
	private Produto criarObjetoProduto() {
		...
		if(!textFieldCodigo.getText().isEmpty()) {
			produto.setCodigo(Integer.parseInt(textFieldCodigo.getText()));
